...
alias Maze.Painter
      ...
      def start_link(maze, options \\ [ ]) do
      ...
      # def changes(world) do
        ...
        # else
          ...
          #       end
          #     end
        def draw_initialized_maze(maze) do
          Enum.each(maze.rooms, fn room ->
          Painter.draw_room(room,@room_size)
          Painter.draw_all_walls(room, @wall_color)
          end)
        end
